...
public class DiscordEventHandlers extends Structure {
    ...
    private static final List FIELD_ORDER = Collections.unmodifiableList(Arrays.asList(new String[] { "ready", "disconnected", "errored", "joinGame", "spectateGame", "joinRequest"}));
